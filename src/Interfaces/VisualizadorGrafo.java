...
// Se resaltan en azul los nodos de la ruta Dijkstra
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Detección de zonas aisladas");

        jLabel6.setFont(new java.awt.Font("Helvetica Neue", 1, 20)); // NOI18N
        jLabel6.setText("Simulación del flujo de señal");

        jLabel8.setText("Nodos rojos (zonas aisladas)");

        jLabel7.setText("Nodos verdes (conectados)");

        jLabel9.setText("Nodos azules (Dijkstra)");

        jToggleButton1.setText("Aplicarlo");
        jToggleButton1.addActionListener(this::jToggleButton1ActionPerformed);

        jToggleButton2.setText("Guardarlo");
        ...
        jLabel10.setText("Deterioro Cognitivo");

        jLabel11.setFont(new java.awt.Font("Helvetica Neue", 1, 20)); // NOI18N
        jLabel11.setText("por fatiga");
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        sf.simularFatiga();
        mostrarGrafo();
        JOptionPane.showMessageDialog(this, "Fatiga simulada. Todos los valores de k multiplicados por 1.2.");
    }//GEN-LAST:event_jToggleButton1ActionPerformed

    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
        // TODO add your handling code here:
        App.getInstance().guardarGrafoDefault();
        JOptionPane.showMessageDialog(this, "Estado de fatiga guardado.");
